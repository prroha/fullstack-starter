...
describe("ProjectGenerator", () => {
  ...
  describe("generateEnvExample()", () => {
    ...
    it("should generate base environment variables", () => {
      ...
      expect(result).toContain("# Generated by Starter Studio");
  ...
  describe("generateLicense()", () => {
    ...
    it("should include Starter Studio branding", () => {
      const result = generateLicense(createMockOrderDetails());

      expect(result).toContain("# Starter Studio License");
      expect(result).toContain("Generated by Starter Studio");
      expect(result).toContain("https://starter.studio");
    });
  ...
  describe("generateReadme()", () => {
    ...
    it("should include support section with order number", () => {
      ...
      expect(result).toContain("## Support");
      expect(result).toContain("https://docs.starter.studio");
    ...
    it("should include Starter Studio branding", () => {
      ...
      expect(result).toContain("Built with Starter Studio");
      expect(result).toContain("https://starter.studio");
    });
  });
