...
export default function CertificateCard({ certificate }: CertificateCardProps) {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      ...
      <div className="relative bg-white border-2 border-amber-300 rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="px-8 py-10 text-center">
          ...
          {/* Divider */}
          <div className="w-16 h-px bg-amber-300 mx-auto mb-6" />
          ...
          <div className="mt-6 inline-flex flex-col items-center">
            <div className="w-20 h-20 bg-gray-100 border border-gray-200 rounded-md flex items-center justify-center">
              <svg
          ...
          <div className="mt-4">
            ...
            <p className="text-sm font-mono font-medium text-gray-700 tracking-wider">
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <svg
            className="w-4 h-4"
            fill="none"
        ...
        <div className="relative">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors"
          >
            <svg
              className="w-4 h-4"
              fill="none"
              ...
              >
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m9.86-2.539a4.5 4.5 0 0 0-1.242-7.244l-4.5-4.5a4.5 4.5 0 0 0-6.364 6.364L5.25 9.503"
                  />
                </svg>
